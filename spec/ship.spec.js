...
describe('Ship class ', function() {
  ...
  describe('method isDestroyed ', function() {
    it('should return false when at leas one deck is not destroyed', function () {
  ...
  describe('method hit ', function() {
    it('should set destroyed status of deck with given coordinates to true', function () {
      console.log(ship)
      ship.hit([1,1]);
    ...
    it('should not change destroyed status of deck with given coordinates to false', function () {
      ship.decks[0].destroyed = true;
      ship.hit([1,1]);
      expect(ship.decks[0].destroyed).toBe(true);
      expect(ship.decks[1].destroyed).toBe(false);
